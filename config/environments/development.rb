Hadean::Application.configure do
  ...
  config.after_initialize do
    ...
    ::GATEWAY = ActiveMerchant::Billing::StripeGateway.new(
      :login    => "sk_test_R5HtlzZkLxTllazo8ppnyZQs"
        #  Make sure this is pointing to the authnet test server.  This needs to be uncommented to test capturing a payment.
    )
    # old netgateway payment
